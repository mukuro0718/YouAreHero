...
/// コンストラクタ
/// </summary>
DragonBreathEffect::DragonBreathEffect(const int _effectResourceHandle)
	...
	, maxEffectNum	(0)
{
	...
	this->scale			 = Gori::Convert(json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_SCALE"]);
	this->startFrame	 = json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_START_FRAME"];
	this->endFrame		 = json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_END_FRAME"];
	this->useFrameIndex1 = json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_FRAME_INDEX_USED_CAPSULE_DIRECTION"][0];
	this->useFrameIndex2 = json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_FRAME_INDEX_USED_CAPSULE_DIRECTION"][1];
	this->maxEffectNum	 = json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_MAX_PLAY_NUM"];
	this->moveSpeed		 = json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_SPEED"];
	this->maxDistance	 = json.GetJson(JsonManager::FileType::EFFECT)["DRAGON_BREATH_MAX_DISTANCE"];
...
/// 更新
/// </summary>
void DragonBreathEffect::Update()
{
