...
/// コンストラクタ
/// </summary>
BeastRaiseLevelEffect::BeastRaiseLevelEffect(const int _effectResourceHandle)
	...
	, useFrameIndex		 (-1)
{
	...
	this->scale			= Gori::Convert(json.GetJson(JsonManager::FileType::EFFECT)["BEAST_RAISE_LEVEL_SCALE"]);
	this->startFrame	= json.GetJson(JsonManager::FileType::EFFECT)["BEAST_RAISE_LEVEL_START_FRAME"];
	this->endFrame		= json.GetJson(JsonManager::FileType::EFFECT)["BEAST_RAISE_LEVEL_END_FRAME"];
	this->useFrameIndex	= json.GetJson(JsonManager::FileType::BEAST)["BACKING_BREATH_FRAME_INDEX_USED_CAPSULE_DIRECTION"][0];
}

/// <summary>
/// 更新
/// </summary>
void BeastRaiseLevelEffect::Update()
{
	...
	if (this->frameCount == 0)
	{
		...
		VECTOR position = MV1GetFramePosition(enemy.GetModelHandle(), this->useFrameIndex);
