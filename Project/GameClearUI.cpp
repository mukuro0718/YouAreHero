...
void GameClearUI::Update()
{
	...
	case ProductStage::EFFECT_FADE_OUT:
		...
		//フェードアウト
		this->effectLogoAlpha -= this->REDUCTION_ALPHA_FOR_EFFECT_FADE_OUT;
	...
	case ProductStage::LOGO_FADE_OUT:
		//拡大処理
		this->logoRate = Gori::LerpFloat(this->logoRate, this->TARGET_LOGO_RATE_FOR_FADE_OUT, this->LERP_VALUE_FOR_FADE_OUT_MAGNIFICATION);
		//フェードアウト
