...
PlayerCombo2::PlayerCombo2()
	...
	, VIBRATION_POWER			(Singleton<JsonManager>::GetInstance().GetJson(JsonManager::FileType::PLAYER)["COMBO2_VIBRATION_POWER"])
	, VIBRATION_TIME			(Singleton<JsonManager>::GetInstance().GetJson(JsonManager::FileType::PLAYER)["COMBO2_VIBRATION_TIME"])
