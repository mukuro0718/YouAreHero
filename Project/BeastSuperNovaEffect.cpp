...
/// コンストラクタ
/// </summary>
BeastSuperNovaEffect::BeastSuperNovaEffect(const int _effectResourceHandle)
	: Effect			 (_effectResourceHandle)
	, scale				 { 0.0f,0.0f,0.0f }
	, playingEffectHandle(-1)
{
	auto& json = Singleton<JsonManager>::GetInstance();
	this->scale		  = Gori::Convert(json.GetJson(JsonManager::FileType::EFFECT)["BEAST_SUPER_NOVA_SCALE"]);
	this->startFrame  = json.GetJson(JsonManager::FileType::EFFECT)["BEAST_SUPER_NOVA_START_FRAME"];
	this->endFrame	  = json.GetJson(JsonManager::FileType::EFFECT)["BEAST_SUPER_NOVA_END_FRAME"];
...
/// 更新
/// </summary>
void BeastSuperNovaEffect::Update()
{
