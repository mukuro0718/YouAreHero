...
/// コンストラクタ
/// </summary>
Tank_GuardReaction::Tank_GuardReaction()
	: isInitialize		(false)
{
...
/// 初期化
/// </summary>
void Tank_GuardReaction::Initialize()
{
...
/// 更新処理
/// </summary>
Tank_GuardReaction::NodeState Tank_GuardReaction::Update(BehaviorTree& _tree, Character& _chara)
{
