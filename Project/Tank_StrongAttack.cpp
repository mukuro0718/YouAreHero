...
/// コンストラクタ
/// </summary>
Tank_StrongAttack::Tank_StrongAttack()
	: isInitialize		(false)
{
...
/// 初期化
/// </summary>
void Tank_StrongAttack::Initialize()
{
...
/// 更新処理
/// </summary>
Tank_StrongAttack::NodeState Tank_StrongAttack::Update(BehaviorTree& _tree, Character& _chara)
{
