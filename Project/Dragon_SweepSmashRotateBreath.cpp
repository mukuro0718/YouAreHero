...
/// コンストラクタ
/// </summary>
Dragon_SweepSmashRotateBreath::Dragon_SweepSmashRotateBreath()
	: useAnimationType	 (0)
	, maxUseAnimation	 (0)
	...
	, isClose			 (false)
{
	...
	vector<float> playTime		= json.GetJson(JsonManager::FileType::DRAGON)["SWEEP_SMASH_ROTATE_BREATH_PLAY_TIME"];
...
/// 更新処理
/// </summary>
Dragon_SweepSmashRotateBreath::NodeState Dragon_SweepSmashRotateBreath::Update()
{
	/*移動処理*/
