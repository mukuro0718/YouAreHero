	...
	, playingEffectHandle(-1)
{
	...
	this->yOffset	 = json.GetJson(JsonManager::FileType::EFFECT)["BOSS_IMPACT_Y_OFFSET"];
	this->scale		 = Gori::Convert(json.GetJson(JsonManager::FileType::EFFECT)["BOSS_IMPACT_SCALE"]);
