	...
	: BossAttack()
{
	...
	//35-40 57-62
	this->onHitCheckFrame = json.GetJson(JsonManager::FileType::ENEMY)["SLASH_COMBO_1_ON_DO_HIT_FRAME"];
	this->offHitChekcFrame = json.GetJson(JsonManager::FileType::ENEMY)["SLASH_COMBO_1_OFF_DO_HIT_FRAME"];
