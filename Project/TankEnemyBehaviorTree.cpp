...
/// コンストラクタ
/// </summary>
TankEnemyBehaviorTree::TankEnemyBehaviorTree()
{
	/*インターバルを初期化*/
...
/// 初期化
/// </summary>
void TankEnemyBehaviorTree::Initialize()
{
	CreateBehaviorTree();
...
/// ビヘイビアツリーを作成
/// </summary>
void TankEnemyBehaviorTree::CreateBehaviorTree()
{
	...
	BehaviorTreeNode* Sequencer_DyingIfHpIsLessThanZero = new SequencerNode();
	{
		...
		Sequencer_DyingIfHpIsLessThanZero->AddChild(*new Tank_Dying());
	}
	...
	BehaviorTreeNode* Selector_NewOrAlreadyReaction = new SelectorNode();
	{
		...
		BehaviorTreeNode* Sequencer_IfAlreadySelectedReaction = new SequencerNode();
		{
			...
			Sequencer_IfAlreadySelectedReaction->AddChild(*new Tank_PlayCurrentReaction());
		}
		//攻撃を受けていたらリアクションを行う
		BehaviorTreeNode* Sequencer_ReactionIfHitAttack = new SequencerNode();
		{
			...
			Sequencer_ReactionIfHitAttack->AddChild(*new Tank_Reaction());
		}
...
/// 更新
/// </summary>
void TankEnemyBehaviorTree::Update(Character& _chara)
{
	/*メンバ変数の更新*/
...
/// 描画
/// </summary>
const void TankEnemyBehaviorTree::Draw()const
{
#ifdef _DEBUG
