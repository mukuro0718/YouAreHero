...
/// 初期化
/// </summary>
void PlayerSpecialAttack::Initialize(GoriLib::Physics* _physics)
{
	/*コライダーの初期化*/
...
/// 後処理
/// </summary>
void PlayerSpecialAttack::Finalize(GoriLib::Physics* _physics)
{
	/*物理登録の解除*/
...
/// 更新
/// </summary>
void PlayerSpecialAttack::Update(GoriLib::Physics* _physics, const VECTOR _position, const VECTOR _direction)
{
	/*シングルトンクラスのインスタンスの取得*/
	auto& json = Singleton<JsonManager>::GetInstance();
...
/// 衝突したか
/// </summary>
void PlayerSpecialAttack::OnCollide(const Collidable& _colider)
{
...
/// 描画
/// </summary>
const void PlayerSpecialAttack::Draw()const
{
#if _DEBUG
	if (this->isStartHitCheck)
	{
	...
	printfDx("SPECIAL_POSITION X:%f,Y:%f,Z:%f\n", position.x, position.y, position.z);
#endif // _DEBUG
}
