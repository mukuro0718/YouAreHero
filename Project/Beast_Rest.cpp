...
Beast_Rest::Beast_Rest()
	...
	, nextStageSet()
{
	this->animationSet.emplace(AnimationStage::START, static_cast<int>(Beast::AnimationType::REST_START));
	this->animationSet.emplace(AnimationStage::LOOP, static_cast<int>(Beast::AnimationType::REST_LOOP));
	this->animationSet.emplace(AnimationStage::END, static_cast<int>(Beast::AnimationType::REST_END));
	...
	this->actionType = static_cast<int>(BeastBehaviorTree::ActionType::REST);
	this->maxSpeed	 = 0.0f;
